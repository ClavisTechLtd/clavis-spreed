Feature: chat-4/threads
  ...
  Scenario: Notification levels
    ...
    And user "participant1" has the following notifications
      | app    | object_type | object_id        | subject                                                               |
      | spreed | chat        | room/Message 1-2/Thread 1 | participant2-displayname (#Thread 1, room) |
    ...
    And user "participant1" has the following notifications
      | app    | object_type | object_id                 | subject                                                               |
      | spreed | chat        | room/Message 1-3/Thread 1 | participant2-displayname (#Thread 1, room)          |
      | spreed | chat        | room/Message 1-2/Thread 1 | participant2-displayname (#Thread 1, room) |
    When user "participant2" sends reply "@participant1" on thread "Thread 1" to room "room" with 201
    Then user "participant1" has the following notifications
      | app    | object_type | object_id                   | subject                                                     |
      | spreed | chat        | room/@participant1/Thread 1 | participant2-displayname (#Thread 1, room) |
      | spreed | chat        | room/Message 1-3/Thread 1   | participant2-displayname (#Thread 1, room)          |
      | spreed | chat        | room/Message 1-2/Thread 1   | participant2-displayname (#Thread 1, room) |
  ...
  Scenario: Reply with an attachment
    ...
    And user "participant1" has the following notifications
      | app    | object_type | object_id       | subject                                                                |
      | spreed | chat        | room1/Message 2/Thread 1 | participant2-displayname (#Thread 1, room1) |
  ...
  Scenario: Thread notifications name the thread
    ...
    Then user "participant1" has the following notifications
      ...
      | spreed | chat        | room1/Message 3/Bảo trì hệ thống | participant2-displayname (#Bảo trì hệ thống, room1) |
  ...
  Scenario: A Closed Thread revived by a reply produces only the ordinary reply notification (Story 4.2, AC6)
    ...
    And user "participant1" has the following notifications
      | app    | object_type | object_id                 | subject                                                                                    |
      | spreed | chat        | room/Message 1-1/Thread 1 | participant2-displayname (#Thread 1, room) |
