OC.L10N.register(
    ...
    "Deleted user ({call})" : "Người dùng đã xoá ({call})",
    "{guest} (guest) ({call})" : "{guest} (khách) ({call})",
    "Guest ({call})" : "Khách ({call})",
    "{user} reacted with {reaction} ({call})" : "{user} đã thả {reaction} ({call})",
    "Deleted user reacted with {reaction} ({call})" : "Người dùng đã xoá đã thả {reaction} ({call})",
    "{guest} (guest) reacted with {reaction} ({call})" : "{guest} (khách) đã thả {reaction} ({call})",
    "Guest reacted with {reaction} ({call})" : "Khách đã thả {reaction} ({call})",
    "Reminder: You ({call})" : "Nhắc nhở: Bạn ({call})",
    "Reminder: {user} ({call})" : "Nhắc nhở: {user} ({call})",
    "Reminder: Deleted user ({call})" : "Nhắc nhở: Người dùng đã xoá ({call})",
    "Reminder: {guest} (guest) ({call})" : "Nhắc nhở: {guest} (khách) ({call})",
    "Reminder: Guest ({call})" : "Nhắc nhở: Khách ({call})",
    "{user} reacted with {reaction}" : "{user} đã thả {reaction}",
    "{user} reacted with {reaction} in {call}" : "{user} đã thả {reaction} trong {call}",
    "Deleted user reacted with {reaction} in {call}" : "Người dùng đã xoá đã thả {reaction} trong {call}",
    "{guest} (guest) reacted with {reaction} in {call}" : "{guest} (khách) đã thả {reaction} trong {call}",
    "Guest reacted with {reaction} in {call}" : "Khách đã thả {reaction} trong {call}",
    "Reminder: You in {call}" : "Nhắc nhở: Bạn trong {call}",
    "Reminder: {user} in {call}" : "Nhắc nhở: {user} trong {call}",
    "Reminder: Deleted user in {call}" : "Nhắc nhở: Người dùng đã xoá trong {call}",
    "Reminder: {guest} (guest) in {call}" : "Nhắc nhở: {guest} (khách) trong {call}",
    "Reminder: Guest in {call}" : "Nhắc nhở: Khách trong {call}",
    "Someone reacted" : "Có người đã thả cảm xúc",
    "Someone mentioned you" : "Có người đã nhắc đến bạn",
    "Someone reacted in a private conversation" : "Có người đã thả cảm xúc trong một cuộc trò chuyện bí mật",
    "You received a message in a private conversation" : "Bạn nhận được một tin nhắn trong một cuộc trò chuyện bí mật",
    "Reminder in a private conversation" : "Nhắc nhở trong một cuộc trò chuyện bí mật",
    "Someone mentioned you in a private conversation" : "Có người đã nhắc đến bạn trong một cuộc trò chuyện bí mật",
    "Notification in a private conversation" : "Thông báo trong một cuộc trò chuyện bí mật",
    "Reminder: You in private conversation {call}" : "Nhắc nhở: Bạn trong cuộc trò chuyện riêng {call}",
    "Reminder: A deleted user in private conversation {call}" : "Nhắc nhở: Một người dùng đã xoá trong cuộc trò chuyện riêng {call}",
    "Reminder: {user} in private conversation" : "Nhắc nhở: {user} trong cuộc trò chuyện riêng",
    "Reminder: You in conversation {call}" : "Nhắc nhở: Bạn trong cuộc trò chuyện {call}",
    "Reminder: {user} in conversation {call}" : "Nhắc nhở: {user} trong cuộc trò chuyện {call}",
    "Reminder: A deleted user in conversation {call}" : "Nhắc nhở: Một người dùng đã xoá trong cuộc trò chuyện {call}",
    "Reminder: {guest} (guest) in conversation {call}" : "Nhắc nhở: {guest} (khách) trong cuộc trò chuyện {call}",
    "Reminder: A guest in conversation {call}" : "Nhắc nhở: Một khách trong cuộc trò chuyện {call}",
    "{user} reacted with {reaction} to your private message" : "{user} đã thả {reaction} vào tin nhắn riêng của bạn",
    "{user} reacted with {reaction} to your message in conversation {call}" : "{user} đã thả {reaction} vào tin nhắn của bạn trong cuộc trò chuyện {call}",
    "A deleted user reacted with {reaction} to your message in conversation {call}" : "Một người dùng đã xoá đã thả {reaction} vào tin nhắn của bạn trong cuộc trò chuyện {call}",
    "{guest} (guest) reacted with {reaction} to your message in conversation {call}" : "{guest} (khách) đã thả {reaction} vào tin nhắn của bạn trong cuộc trò chuyện {call}",
    "A guest reacted with {reaction} to your message in conversation {call}" : "Một khách đã thả {reaction} vào tin nhắn của bạn trong cuộc trò chuyện {call}",
    "{user} mentioned group {group} in conversation {call}" : "{user} đã nhắc đến nhóm {group} trong cuộc trò chuyện {call}",
    "{user} mentioned team {team} in conversation {call}" : "{user} đã nhắc đến đội {team} trong cuộc trò chuyện {call}",
    "{user} mentioned everyone in conversation {call}" : "{user} đã nhắc đến mọi người trong cuộc trò chuyện {call}",
    "A deleted user mentioned group {group} in conversation {call}" : "Một người dùng đã xoá đã nhắc đến nhóm {group} trong cuộc trò chuyện {call}",
    "A deleted user mentioned team {team} in conversation {call}" : "Một người dùng đã xoá đã nhắc đến đội {team} trong cuộc trò chuyện {call}",
    "A deleted user mentioned everyone in conversation {call}" : "Một người dùng đã xoá đã nhắc đến mọi người trong cuộc trò chuyện {call}",
    "{guest} (guest) mentioned group {group} in conversation {call}" : "{guest} (khách) đã nhắc đến nhóm {group} trong cuộc trò chuyện {call}",
    "{guest} (guest) mentioned team {team} in conversation {call}" : "{guest} (khách) đã nhắc đến đội {team} trong cuộc trò chuyện {call}",
    "{guest} (guest) mentioned everyone in conversation {call}" : "{guest} (khách) đã nhắc đến mọi người trong cuộc trò chuyện {call}",
    "A guest mentioned group {group} in conversation {call}" : "Một khách đã nhắc đến nhóm {group} trong cuộc trò chuyện {call}",
    "A guest mentioned team {team} in conversation {call}" : "Một khách đã nhắc đến đội {team} trong cuộc trò chuyện {call}",
    "A guest mentioned everyone in conversation {call}" : "Một khách đã nhắc đến mọi người trong cuộc trò chuyện {call}",
    "View message" : "Xem tin nhắn",
    "Dismiss reminder" : "Bỏ qua nhắc nhở",
    "A thread was locked" : "Một chủ đề đã bị khoá",
    "A thread was closed" : "Một chủ đề đã được đóng",
    "A thread was unlocked" : "Một chủ đề đã được mở khoá",
    "A thread was reopened" : "Một chủ đề đã được mở lại",
    "A thread was locked in a private conversation" : "Một chủ đề đã bị khoá trong một cuộc trò chuyện bí mật",
    "A thread was closed in a private conversation" : "Một chủ đề đã được đóng trong một cuộc trò chuyện bí mật",
    "A thread was unlocked in a private conversation" : "Một chủ đề đã được mở khoá trong một cuộc trò chuyện bí mật",
    "A thread was reopened in a private conversation" : "Một chủ đề đã được mở lại trong một cuộc trò chuyện bí mật",
    "Locked thread {thread} ({reason})" : "Đã khoá chủ đề {thread} ({reason})",
    "Locked thread {thread}" : "Đã khoá chủ đề {thread}",
    "Closed thread {thread}" : "Đã đóng chủ đề {thread}",
    "Unlocked thread {thread}" : "Đã mở khoá chủ đề {thread}",
    "Reopened thread {thread}" : "Đã mở lại chủ đề {thread}",
    "{user} locked thread {thread} in conversation {call} ({reason})" : "{user} đã khoá chủ đề {thread} trong cuộc trò chuyện {call} ({reason})",
    "{user} locked thread {thread} in conversation {call}" : "{user} đã khoá chủ đề {thread} trong cuộc trò chuyện {call}",
    "{user} closed thread {thread} in conversation {call}" : "{user} đã đóng chủ đề {thread} trong cuộc trò chuyện {call}",
    "{user} unlocked thread {thread} in conversation {call}" : "{user} đã mở khoá chủ đề {thread} trong cuộc trò chuyện {call}",
    "{user} reopened thread {thread} in conversation {call}" : "{user} đã mở lại chủ đề {thread} trong cuộc trò chuyện {call}",
    "A deleted user locked thread {thread} in conversation {call} ({reason})" : "Một người dùng đã xoá đã khoá chủ đề {thread} trong cuộc trò chuyện {call} ({reason})",
    "A deleted user locked thread {thread} in conversation {call}" : "Một người dùng đã xoá đã khoá chủ đề {thread} trong cuộc trò chuyện {call}",
    "A deleted user closed thread {thread} in conversation {call}" : "Một người dùng đã xoá đã đóng chủ đề {thread} trong cuộc trò chuyện {call}",
    "A deleted user unlocked thread {thread} in conversation {call}" : "Một người dùng đã xoá đã mở khoá chủ đề {thread} trong cuộc trò chuyện {call}",
    "A deleted user reopened thread {thread} in conversation {call}" : "Một người dùng đã xoá đã mở lại chủ đề {thread} trong cuộc trò chuyện {call}"
},
"nplurals=1; plural=0;");
